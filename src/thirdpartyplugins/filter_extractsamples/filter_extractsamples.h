...
#ifndef MESHLAB_FILTER_EXTRACTSAMPLES_PLUGIN_H
#define MESHLAB_FILTER_EXTRACTSAMPLES_PLUGIN_H

// from meshlab common, include the abstract class file of filter plugins
#include <common/plugins/interfaces/filter_plugin.h>

/**
 * @brief The FilterExtractSamplesPlugin class
 ...
 */
class FilterExtractSamplesPlugin : public QObject, public FilterPlugin
{
...
public:
	...
	enum FileterIds {FP_PRINT_SAMPLES};

	FilterExtractSamplesPlugin();
...
#endif //MESHLAB_FILTER_EXTRACTSAMPLES_PLUGIN_H
